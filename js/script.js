...
function onCardClick(card, i) {
    ...
    // set the text for openContentText depending on the card that was clicked
    if (i === 0) {
        openContentText.innerHTML = '<h1>' + card.children[2].textContent + '</h1>' + "Text 1";
    } else if (i === 1) {
        openContentText.innerHTML = '<h1>' + card.children[2].textContent + '</h1>' + "Tout les 2 ans a lieu le salon Automatic Lille Europe, un rassemblement de professionnels de la santé, notamment du secteur des handicaps, personnes âgées et maintien à domicile. Gratuit et accessible à tout le monde, il y aura des animations, des conférences et des débats dans le but de proposer des solutions aux personnes dans le besoin. Le 6 et 7 décembre 2021 au Grand Palais de Lille.";
    } else if (i === 2) {
        ...
        openContentText.innerHTML = '<h1>' + card.children[2].textContent + '</h1>' + "Le 9 octobre 2023 : Cette journée, à l'initiative de l'assemblée générale des nations unies depuis 2011a pour but de sensibiliser a l’article 14 de la loi du 11 février 2005 et de favoriser l'integration sociale des handicapée dans la société";
    }
}
